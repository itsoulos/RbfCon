...
{
    cout<<"Είμαστε στο NeuralProgram::getTrainError(Data x)\n";
    int t;
    cin>>t;
...
int	NeuralProgram::getElements(vector<int> &genome,string &str1)
{
	...
	int redo=0;
//    cout<<"Είμαστε στο NeuralProgram::getElements ppp\n";
    str1=printRandomProgram(genome,redo);
//    cout<<"Είμαστε στο NeuralProgram::getElements pppppppppppppppppppppppppppppppppppppppppppppp\n";
